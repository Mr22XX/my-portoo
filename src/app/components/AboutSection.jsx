...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Junior Web Developer - VSGA Digitalent Kominfo</li>
        <li>Informatika - Universitas Bengkulu</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Badan Nasional Sertifikasi Profesi (BNSP) - Junior Web Developer</li>
        <li>SAP Analytics Cloud and SAP Build Apps Online Training Session</li>
      </ul>
    ),
  },
];
